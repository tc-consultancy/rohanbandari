    ...
    return (
        <div className='relative'>
            ...
            <div className="space-y-3 max-w-5xl  text-center mt-8 mx-auto">
                ...
                <p className="text-sm md:text-base font-medium text-neutral-800">My foundation in this field is built on a strong academic backgrounds</p>
                <section className="flex flex-col md:flex-row gap-12 py-4 items-center justify-center w-full">
                    <div className="h-28 flex-1 border-2 border-neutral-300 rotate-3 shadow-2xs text-start py-6 px-8 rounded-full relative">
                        ...
                        <p className="text-sm leading-tight text-neutral-600">Bachelor of Technology - BTech</p>
                        <p className="text-sm leading-tight text-neutral-600">2019 - 2023</p>
                    </div>
                    <div className="h-28 flex-1 border-2 border-neutral-300 -rotate-3 shadow-2xs text-start py-6 px-8 rounded-full relative">
                        ...
                        <h4 className="text-xl leading-tight font-semibold">University of North Texas</h4>
                        <p className="text-sm leading-tight text-neutral-600">Master of Science - MS, Computer Science</p>
                        <p className="text-sm leading-tight text-neutral-600">2023 - 2025</p>
                    </div>
                </section>
                <p className="text-sm md:text-base font-medium text-neutral-800">My foundation in the field is built on a Master of Science in Computer Science from the University of North Texas, where I specialized in Artificial Intelligence and honed my skills in Python and other key technologies.</p>
                <p className="text-sm md:text-base font-medium text-neutral-800">Today, my focus is on Generative AI. I lead projects at Wells Fargo, where I built a compliance system using LLMs, RAG, and multi-agent pipelines. This solution dramatically improved efficiency, reducing audit review time by 75% and increasing fraud detection by 50%. I have hands-on expertise with a range of tools including LangChain, CrewAI, Pinecone, SageMaker, and Azure OpenAI, with a commitment to creating scalable, production-ready, and transparent systems.</p>
